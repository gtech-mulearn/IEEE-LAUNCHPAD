...
|---------------------|---------------------------------------------------------------------------|------------------------------------------|----------------------------------------------------------------|
| **Project Name 1**  |    CodeMate, a dynamic live code editor that I developed using HTML, CSS, and JavaScript. 🌟

CodeMate is your go-to tool for HTML, CSS, and JavaScript coding, offering separate spaces for typing code and instantly previewing the output. 🖥️💡
