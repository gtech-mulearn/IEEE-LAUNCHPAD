...
>  I am a Curious Guy who loves to tinker with tech and build products. Basically, I am a Python Developer but I don't want to limit myself to that one stack and I love exploring new things. I am the Author of [SQL-Ease](https://sqlease.buildnship.in), a AI powered webapp which lets you convert natural language into SQL Query. Now, my interest is more into building and shipping products
---
...
**DocketGo** - *AI Researcher* (Jan. 2023 - May 2023)
...
- Significantly improved law point extraction accuracy by 25% through advanced tuning of Large Language Models (LLMs), enabling deeper insights and analysis of legal documents specific to the Indian context.

**GTech Mulearn** - *Bot Developer* (Jan. 2022 – June 2023)
- Developed and integrated advanced chat moderation and user engagement features into the Discord bot, significantly enhancing user experience for over 1600 community members.

**GTech Mulearn** - *AI Interest Group Lead* (Jan. 2023 - June 2023)
- Managed Mulearn AI learning circles across Kerala, promoting peer-to-peer learning and collaborative growth among students.
- Structured multiple bootcamps and courses to engage students in AI learning, fostering meaningful interactions and effective learning outcomes.
- Connected mentors and students by organizing weekly office hours on Discord and occasional sessions for doubt clearing and updates on the latest tools and news in AI.
- Conducted Think Tank meetings with mentors and interest group leads for future planning and fun, enhancing collaboration and innovation within the community.
- Hosted weekly virtual sessions titled "Grab Your Super Powers", showcasing new tools and technologies in AI to empower participants.

**TinkerHub Foundation** - *Campus Lead* (May 2021 - April 2023)
- Managed a team to oversee the development and engagement of 150+ students, fostering a collaborative learning environment focused on technical and social skills.
...
> Campus Lead at TinkerHub Foundation
...
> Bot Developer at GTech Mulearn
