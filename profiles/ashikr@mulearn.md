...
>Hello, tech visionaries! I'm Ashik R , a technology enthusiast from tvm .Thriving team player and an excellent team worker and am able to take instructions from all levels and build up good working relationships with all colleagues. Skilled in circuit design & simulation, with strong foundations in analysis, PCB design, and programming. Highly motivated learner eager to contribute with problem-solving abilities and a
strong work ethic. Organized and dependable candidate successful at managing multiple priorities with a positive attitude. Willingness to take on added responsibilities to meet team goals. My
