...
|---------------------|---------------------------------------------------------------------------|----------------------------------------------------------------|
| **cyberbullying dtection and prevention - **  | created a demo system for real time cyberbullying detection which instantly detects the cyberbullying contents through users post and through their commands and opinions,in front end we have used python django nd in backend we used machine learning in detection part followed by python django. T                                            | [Repo Link 1](https://github.com/minhaj-v-s/Safelink)             |
